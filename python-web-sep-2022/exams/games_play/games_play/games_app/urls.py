...
from games_play.games_app.views import index, profile_create, dashboard, game_create, \
    game_details, game_edit, game_delete, profile_details, profile_edit, profile_delete
